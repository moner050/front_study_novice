            ...
            <>
                <header id="header">
                    <div className="container clearfix">
                        <div className="left">
                            <h1><a href="./index.html" className="logo-btn" title="StarbugsLogo"><img src="img/logo.png" alt="logo" /></a></h1>
                        </div>
                        <div className="right">
                            <div className="top">
                                        ...
                                        <li>
                                            <form name="fsearch" id="fsearch" method="post" action="./search.html">
                                                <div>
                                                    ...
                                                    <a href="#" className="search-btn"><img src="img/icon_magnifier_black.png" alt="돋보기" />
                                                    </a>
                                                </div>
                                            </form>
                                        </li>
                            ...
                            <div className="mobile">
                                <ul>
                                    ...
                                    <li><a href="#" className="burger-btn"><img src="./img/btn_berger_m.png" alt="" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
